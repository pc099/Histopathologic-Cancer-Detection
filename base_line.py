...
import imgaug
os.chdir('C:\projects\cancer_detection')
...
labeled_files = glob('histopathologic-cancer-detection/train/*.tif')
test_files = glob('histopathologic-cancer-detection/test/*.tif')

print(len(labeled_files))
print(len(test_files))

train, val = train_test_split(labeled_files, test_size= 0.1, random_state=100000)
